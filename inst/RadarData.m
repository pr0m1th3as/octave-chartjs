...
classdef RadarData
## -*- texinfo -*-
## @deftypefn  {chartjs} {@var{obj} =} RadarData (@var{data})
##
## Create a @qcode{RadarData} object.
##
## @code{@var{obj} = RadarData (@var{data})} returns a @qcode{RadarData}
...
## @qcode{RadarData} object always assigns the default property values, which
## can later be modified using dot notation syntax.
##
## A @qcode{RadarData} object, @var{obj}, contains the following properties:
##
...
## @qcode{RadarData} object.  It cannot be empty.
##
