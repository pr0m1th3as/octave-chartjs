...
## -*- texinfo -*-
## @deftypefn  {chartjs} {@var{obj} =} PieChart (@var{data}, @var{labels})
## @deftypefnx {chartjs} {@var{obj} =} PieChart (@dots{}, @var{Name}, @var{Value})
##
## Create a @qcode{PieChart} object.
##
## @code{@var{obj} = PieChart (@var{data}, @var{labels})} returns a
## @qcode{PieChart} object, in which @var{data} contains the proportional arc
## segments and @var{labels} contain the labels of each segment.
##
## @itemize
## @item
...
## @end itemize
##
## @code{@var{obj} = PieChart (@dots{}, @var{Name}, @var{Value})} returns a
## @qcode{PieChart} object with the properties of each dataset specified by
## one or more @qcode{@var{Name}, @var{Value}} pair arguments.  @var{Name} can
## be any property name of a @qcode{PieData} object and @var{Value} must
...
## @qcode{PieChart} constructor the same values accepted by the constructor
## of the @qcode{Color} object.  However, if you choose to manually modify the
## @qcode{PieChart}'s properties using the dot notation syntax, then you
...
##
## A @qcode{PieChart} object, @var{obj}, stores the following properties,
...
## @end multitable
##
## To directly serve the @qcode{PieChart} object on a local web server
...
##
## @seealso{PieData, Color, Fill, Html, WebServer}
## @end deftypefn
